...
/// @nodoc
mixin _$RegisterResponse implements DiagnosticableTreeMixin {

 String get message; String get userId;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('message', message))..add(DiagnosticsProperty('userId', userId));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RegisterResponse&&(identical(other.message, message) || other.message == message)&&(identical(other.userId, userId) || other.userId == userId));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String message,  String userId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegisterResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String message,  String userId)  $default,) {final _that = this;
switch (_that) {
case _RegisterResponse():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String message,  String userId)?  $default,) {final _that = this;
switch (_that) {
case _RegisterResponse() when $default != null:
return $default(_that.message,_that.userId);case _:
  return null;
...
class _RegisterResponse with DiagnosticableTreeMixin implements RegisterResponse {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RegisterResponse&&(identical(other.message, message) || other.message == message)&&(identical(other.userId, userId) || other.userId == userId));
}
